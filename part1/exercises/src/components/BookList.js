export default function BookList() {
   let bookList = "This is a Book List";
   ...
   return (
      <div>
         <h3>{bookList}</h3>
         <img src={book1} width="300" alt="Learn Javascript" />
         <img src={book2} width="300" alt="Goodbye Stress" />
         <img src={book3} width="300" alt="Hello New career" />
      </div>      
   );
}